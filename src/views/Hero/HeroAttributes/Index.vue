<template>
  <div class="h-attriubutes">
    ...
    <div class="attributes">
      ...
      <div class="core">
        <hero-attribute-list :attributes="coreAttributes"></hero-attribute-list>
      </div>
      ...
      <div class="secondary">
        <hero-attribute-list :attributes="secondaryAttributes"></hero-attribute-list>
      </div>
    ...
    <!-- Recursos -->
    <div class="resources">
      <hero-resources :resources="resources"></hero-resources>
    </div>
